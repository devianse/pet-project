...
// One-off hand fix (not a general license to edit vendored pouf/ files):
// upstream registry's disclosure.json source has an unused `toneClass`
// import here. Removed to satisfy noUnusedLocals. A future `npx shadcn add`
// re-vendor will reintroduce this line — expected; re-remove it the same
// way, it's not a regression.
